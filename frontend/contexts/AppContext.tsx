...
export const actions = {
  ...
  setParticipants: (participants: Participant[]): AppAction => ({
    type: "SET_PARTICIPANTS",
    payload: participants,
  }),
  addParticipant: (participant: Participant): AppAction => ({
    type: "ADD_PARTICIPANT",
    payload: participant,
  }),
  updateParticipant: (participant: Participant): AppAction => ({
    type: "UPDATE_PARTICIPANT",
    payload: participant,
  }),
  deleteParticipant: (id: string): AppAction => ({
    type: "DELETE_PARTICIPANT",
    payload: id,
  }),
  setRooms: (rooms: Room[]): AppAction => ({
    type: "SET_ROOMS",
    payload: rooms,
  }),
  addRoom: (room: Room): AppAction => ({ type: "ADD_ROOM", payload: room }),
  updateRoom: (room: Room): AppAction => ({
    type: "UPDATE_ROOM",
    payload: room,
  }),
  deleteRoom: (id: string): AppAction => ({ type: "DELETE_ROOM", payload: id }),
  setFellowships: (fellowships: string[]): AppAction => ({
    type: "SET_FELLOWSHIPS",
    payload: fellowships,
  }),
  setFormData: (formData: Partial<FormData>): AppAction => ({
    type: "SET_FORM_DATA",
    payload: formData,
  }),
  resetFormData: (): AppAction => ({ type: "RESET_FORM_DATA" }),
  setSelectedDate: (date: Dayjs): AppAction => ({
    type: "SET_SELECTED_DATE",
    payload: date,
  }),
  setSelectedYear: (year: Dayjs): AppAction => ({
    type: "SET_SELECTED_YEAR",
    payload: year,
  }),
  setModalOpen: (open: boolean): AppAction => ({
    type: "SET_MODAL_OPEN",
    payload: open,
  }),
  setEditingParticipant: (participant: Participant | null): AppAction => ({
    type: "SET_EDITING_PARTICIPANT",
    payload: participant,
  }),
};
